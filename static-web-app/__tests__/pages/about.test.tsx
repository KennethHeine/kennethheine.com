...
describe('About Page', () => {
  ...
  it('displays professional background', () => {
    ...
    const professionalElements = screen.getAllByText(/developer|engineer|architect/i)
  ...
  it('displays expertise areas', () => {
    ...
    const expertiseElements = screen.getAllByText(/AI|automation|infrastructure/i)
  ...
  it('has proper page structure for SEO', () => {
    ...
    const experienceElements = screen.getAllByText(/experience|background|journey/i)
  ...
  it('applies responsive design classes', () => {
    ...
    const responsiveElements = container.querySelectorAll('.max-w-7xl, .mx-auto, .max-w-4xl')
  ...
  it('includes timeline or career history', () => {
    ...
    const careerElements = screen.getAllByText(/experience|career|timeline|history/i)
