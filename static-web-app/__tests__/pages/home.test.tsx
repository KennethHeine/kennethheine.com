...
describe('Home Page', () => {
  ...
  it('displays hero section content', () => {
    ...
    expect(screen.getByText(/AI, Automation & Cloud Architecture for Developers/i)).toBeInTheDocument()
  })
  ...
  it('applies responsive design classes', () => {
    ...
    const responsiveElements = container.querySelectorAll('.max-w-7xl, .mx-auto')
  ...
  it('includes CTA or call-to-action elements', () => {
    ...
    const ctaElements = screen.queryAllByText(/Learn More About Me|Read My Blog|Get in touch|View all posts/i)
