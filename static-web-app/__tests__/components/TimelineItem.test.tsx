...
describe('TimelineItem component', () => {
  ...
  it('renders timeline item with all props', () => {
    ...
    expect(screen.getByText('Working on amazing projects with cutting-edge technology.')).toBeInTheDocument()
  })
  ...
  it('handles long descriptions properly', () => {
    const longDescriptionProps = {
      ...
      item: {
        ...defaultProps.item,
        description: 'This is a very long description that should wrap properly and be displayed correctly in the timeline component without breaking the layout or causing any visual issues.',
      },
    }
