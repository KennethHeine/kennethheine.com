...
import { Typography, TypographyProps, TypographyVariant, TypographyElement } from '../../../components/ui/Typography';
...
describe('Typography component', () => {
  ...
  describe('Typography variants', () => {
    const variants: TypographyVariant[] = [
      ...
      'caption', 'overline', 'lead', 'small', 'muted'
    ];
      ...
      it(`applies ${variant} variant styling correctly`, () => {
        ...
        switch (variant) {
          case 'h1':
            ...
            break;
          case 'h2':
            expect(element).toHaveClass('text-3xl', 'font-bold', 'leading-tight', 'tracking-tight');
            break;
          case 'h3':
            expect(element).toHaveClass('text-2xl', 'font-semibold', 'leading-tight');
            break;
          case 'h4':
            expect(element).toHaveClass('text-xl', 'font-semibold', 'leading-tight');
            break;
          case 'h5':
            expect(element).toHaveClass('text-lg', 'font-medium', 'leading-tight');
            break;
          case 'h6':
            expect(element).toHaveClass('text-base', 'font-medium', 'leading-tight');
            break;
          case 'subtitle1':
            expect(element).toHaveClass('text-lg', 'font-medium', 'leading-relaxed');
            break;
          case 'subtitle2':
            expect(element).toHaveClass('text-base', 'font-medium', 'leading-relaxed');
            break;
          case 'body1':
            expect(element).toHaveClass('text-base', 'leading-relaxed');
            break;
          case 'body2':
            ...
            break;
          case 'caption':
            expect(element).toHaveClass('text-xs', 'leading-normal', 'text-gray-600', 'dark:text-gray-400');
            break;
          case 'overline':
            expect(element).toHaveClass('text-xs', 'uppercase', 'tracking-wide', 'font-medium');
            break;
          case 'lead':
            expect(element).toHaveClass('text-lg', 'leading-relaxed', 'text-gray-700', 'dark:text-gray-300');
            break;
          case 'small':
            expect(element).toHaveClass('text-sm', 'leading-normal', 'text-gray-600', 'dark:text-gray-400');
            break;
          case 'muted':
            expect(element).toHaveClass('text-sm', 'leading-normal', 'text-gray-500', 'dark:text-gray-500');
            break;
        }
      });
    });
  ...
  describe('Accessibility', () => {
    it('maintains proper heading hierarchy semantics', () => {
      render(
        <div>
          ...
          <Typography variant="h3" as="h3">Subsection Title</Typography>
        </div>
      );
    ...
    it('allows semantic override for visual hierarchy', () => {
      ...
      render(<Typography variant="h1" as="h2">Visual H1, Semantic H2</Typography>);
      
      const heading = screen.getByRole('heading', { level: 2 });
      expect(heading).toHaveTextContent('Visual H1, Semantic H2');
      expect(heading).toHaveClass('text-4xl', 'font-bold', 'leading-tight', 'tracking-tight'); // h1 visual styles
    });
  ...
  describe('Responsive behavior', () => {
    ...
    it('maintains base styles with responsive overrides', () => {
      ...
      expect(element).toHaveClass(
        'text-3xl', 'font-bold', 'leading-tight', 'tracking-tight', // Base h2 styles
        'text-center', 'md:text-left', 'lg:text-right' // Responsive classes
      );
    });
  });
  ...
  describe('Dark mode support', () => {
    ...
    it('includes dark mode classes for muted text', () => {
      ...
      const element = screen.getByRole('paragraph');
      expect(element).toHaveClass('text-gray-500', 'dark:text-gray-500', 'leading-normal');
    });

    it('includes dark mode classes for caption text', () => {
      render(<Typography variant="caption">Test content</Typography>);
      const element = screen.getByText('Test content');
      expect(element).toHaveClass('text-gray-600', 'dark:text-gray-400', 'leading-normal');
    });

    it('includes dark mode classes for lead text', () => {
      render(<Typography variant="lead" />);
      const element = screen.getByRole('paragraph');
      expect(element).toHaveClass('text-gray-700', 'dark:text-gray-300', 'leading-relaxed');
    });
  });
  ...
  describe('Edge cases and error handling', () => {
    it('preserves existing classes when merging', () => {
      render(
        <Typography 
          variant="h1" 
          className="existing-class another-class"
        />
      );
      
      const element = screen.getByRole('heading', { level: 1 });
      expect(element).toHaveClass(
        'text-4xl', 'font-bold', 'leading-tight', 'tracking-tight', // variant classes
        'existing-class', 'another-class' // custom classes
      );
    });
