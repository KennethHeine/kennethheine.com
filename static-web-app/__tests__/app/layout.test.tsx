...
describe('metadata configuration', () => {
  ...
  it('includes proper OpenGraph configuration', () => {
    ...
    expect(metadata.openGraph?.url).toBe('https://kennethheine.com')
    expect(metadata.openGraph?.siteName).toBe('Kenneth Heine')
  ...
  it('includes proper Twitter configuration', () => {
    ...
    expect(metadata.twitter?.title).toContain('Kenneth Heine')
    expect(metadata.twitter?.description).toContain('Kenneth Heine helps developers')
