...
<ResponsiveImage 
  src="/images/blog/example-architecture.jpg"
  alt="AI-enhanced Infrastructure as Code workflow diagram showing traditional vs AI-assisted development"
  width={800}
  height={400}
  caption="Figure 1: Traditional IaC development vs AI-enhanced workflow"
/>
