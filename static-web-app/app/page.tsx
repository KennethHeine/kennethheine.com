...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      {/* Quick Introduction with modern card design */}
      <section
      ...
      >
        <Container>
          <div className='mx-auto max-w-3xl text-center'>
            ...
            {/* Quick Stats with modern glass cards */}
            <div
              className='mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3'
              role='group'
              aria-label='Professional experience metrics'
            >
              <div className='group relative overflow-hidden rounded-2xl glass-card p-6 transition-all duration-300 hover:scale-105 hover:shadow-2xl'>
